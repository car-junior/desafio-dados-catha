...
import scripts.utils.manipula_arquivo as arquivo
...
#
# variancia_dados_2010_2021 = MontaDados.via_arquivos_csv_gerados(caminho_raiz=DiretorioArquivoPeriodo.DESVIO_PADRAO)
